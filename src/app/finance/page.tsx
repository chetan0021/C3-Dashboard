  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="glass rounded-2xl p-5 border border-fuchsia-400/20 hover:scale-[1.02] transition-transform duration-200">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center justify-center w-9 h-9 rounded-xl bg-fuchsia-400/15">
              <Zap className="w-5 h-5 text-fuchsia-400" />
            </div>
            <TrendingUp className="w-4 h-4 text-fuchsia-400 opacity-60" />
          </div>
          <p className="text-xl font-bold text-fuchsia-400">{formatINR(stats.passiveStrategy)}</p>
        ...
        <div className={cn(
          ...
          stats.net >= 0 ? 'border-violet-400/20' : 'border-red-400/30'
        )}>
          <div className="flex items-center justify-between mb-3">
            <div className={cn('flex items-center justify-center w-9 h-9 rounded-xl', stats.net >= 0 ? 'bg-violet-400/15' : 'bg-red-400/15')}>
              <Target className={cn('w-5 h-5', stats.net >= 0 ? 'text-violet-400' : 'text-red-400')} />
            </div>
            <Zap className={cn('w-4 h-4 opacity-60', stats.net >= 0 ? 'text-violet-400' : 'text-red-400')} />
          </div>
          <p className={cn('text-xl font-bold', stats.net >= 0 ? 'text-violet-400' : 'text-red-400')}>
            {formatINR(stats.net)}
          </p>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[11px] text-muted-foreground">
                    ...
                    <span className={cn(
                      ...
                      r.strategy_tag === 'Strategy' ? 'bg-violet-400/10 text-violet-400' :
