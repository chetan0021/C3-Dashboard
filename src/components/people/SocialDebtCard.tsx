...
export function SocialDebtCard() {
  ...
  return (
    <div className="glass rounded-2xl p-6 border border-orange-400/20 bg-orange-400/5 relative overflow-hidden group flex flex-col transition-all hover:border-orange-400/40">
      ...
      <div className="mt-6 pt-4 border-t border-white/5">
        <Link 
          href="/people" 
          className="text-[10px] font-bold text-orange-400 hover:text-orange-300 flex items-center gap-1 transition-colors uppercase tracking-wider"
        >
